# Miniclip Simulator — Copilot Instructions

> **Sync note:** This file is kept in sync with [`AI.md`](../AI.md), which is the canonical source of truth.
> `AI.md` is the tool-agnostic version. `AGENTS.md` and `CLAUDE.md` redirect to it.
> When updating project context, update `AI.md` first, then mirror the changes here.
